...
class Sale extends Model
{
    ...
    // ✅ FIXED: Per-User Transaction Code Methods dengan format TR + YYMMDD + 6-digit sequence
    public static function getNextTransactionCode($userId = null)
    {
        // ✅ Dalam static context, userId harus diberikan
        if (!$userId) {
        ...
        $datePrefix = 'TR' . $year . $month . $day; // TR250829
